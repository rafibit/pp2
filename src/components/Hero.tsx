  ...
  return (
    <div className="py-12">
      <div className="mx-auto max-w-6xl px-4 grid grid-cols-1 md:grid-cols-[1fr_260px] gap-10 items-start">
        ...
        >
          {/* Profile Image */}
          <div className="w-52 h-52 rounded-full border-2 border-slate-200 ring-2 ring-brand-200 overflow-hidden bg-slate-100 flex items-center justify-center shadow-sm">
            <img
